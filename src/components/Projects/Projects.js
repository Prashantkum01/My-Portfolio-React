        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Rajuk75/Hello_India.git"
              demoLink="https://hello-india.onrender.com/listings"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Rajuk75/AI-Powered-Mental-Health-Tracker.git"
              demoLink="https://github.com/Rajuk75/AI-Powered-Mental-Health-Tracker.git"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Rajuk75/AI-Trip-Navigator.git"
              demoLink="https://github.com/Rajuk75/AI-Trip-Navigator.git"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Rajuk75/Soldier-Monitoring-Final-Project-.git"
              demoLink="https://soldier-health-monitoring.com/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/RajuKumar/PersonalExpenseTracker"
              demoLink="https://personal-expense-tracker.com/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/RajuKumar/HospitalManagementSystem"
              demoLink="https://hospital-management-system.com/"
            />
          </Col>
